                  ...
                  >
                    {products.map((product) => (
                      <div
                        ...
                        className=" cursor-pointer w-full text-left px-4 py-2.5 rounded-md text-sm font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200"
                      >
                        {t(product.key)}
                      </div>
                    ))}
